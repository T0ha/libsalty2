defmodule Salty.Nif do
  ...
  def generichash_blake2b_with_key(_,_,_), do: :erlang.exit(:salty_nif_not_loaded)
  def generichash_blake2b_salt_personal(_,_,_,_,_), do: :erlang.exit(:salty_nif_not_loaded)
  def generichash_blake2b_init(_), do: :erlang.exit(:salty_nif_not_loaded)
  def generichash_blake2b_init_with_key(_,_), do: :erlang.exit(:salty_nif_not_loaded)
